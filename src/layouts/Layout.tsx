const Layout: React.FC = ({ children }) => {
  return (
    <div className="min-w-screen flex min-h-screen flex-col items-center dark:bg-slate-700 dark:text-white">
      <header className="sticky top-0 z-50 mb-2 flex min-h-full w-full flex-col items-center justify-center bg-slate-50 py-2 shadow-sm dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-800 sm:p-2 ">
